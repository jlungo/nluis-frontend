                            ...
                            <div className='sticky top-[4rem] lg:top-[4.8rem] -mt-6 lg:-mt-8 bg-background h-14 lg:h-[4.2rem] flex items-end px-1 -mx-1 rounded-b-2xl'>
                                <div
                                    ...
                                    <Link
                                        ...
                                        className={cn(buttonVariants({ size: 'sm', variant: location.pathname.endsWith('portal') ? 'default' : 'ghost' }), "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-full border border-transparent px-2 py-1 text-sm font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 dark:text-white/80")}
                                    >
                                        Overview
                                    </Link>
                                    <Link
                                        ...
                                        data-slot="tabs-trigger"
                                        className={cn(buttonVariants({ size: 'sm', variant: location.pathname.includes('browse-maps') ? 'default' : 'ghost' }), "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-full border border-transparent px-2 py-1 text-sm font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 dark:text-white/80")}
                                    >
                                    ...
                                    <Link
                                        to="/portal/my-maps"
                                        data-slot="tabs-trigger"
                                        className={cn(buttonVariants({ size: 'sm', variant: location.pathname.includes('my-maps') ? 'default' : 'ghost' }), "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-full border border-transparent px-2 py-1 text-sm font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 dark:text-white/80")}
                                    >
                                        My Maps
                                    </Link>
                                    <Link
                                        ...
                                        data-slot="tabs-trigger"
                                        className={cn(buttonVariants({ size: 'sm', variant: location.pathname.includes('account-settings') ? 'default' : 'ghost' }), "focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-full border border-transparent px-2 py-1 text-sm font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 dark:text-white/80")}
                                    >
