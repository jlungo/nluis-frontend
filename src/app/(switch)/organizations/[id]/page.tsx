        ...
        <CardContent className="pt-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="mt-1 text-sm text-muted-foreground flex flex-wrap items-center gap-3">
                  <span>Type: {organization.type_name}</span>
                  <Separator
            ...
            <div className="flex items-center gap-6">
              ...
              <Stat
                label="Projects"
                value={organization.projects_count || 0}
                ...
                <div className="w-full overflow-x-auto">
                  <div className="rounded-md border">
                    <DataTable
                      ...
                      columns={ListOrganizationProjectsColumns}
                      isLoading={loading}
                      showRowNumbers
                      enableGlobalFilter
        ...
        <TabsContent value="members">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button
                size="sm"
                onClick={() => navigate(`/organizations/${id}/members/new`)}
              >
