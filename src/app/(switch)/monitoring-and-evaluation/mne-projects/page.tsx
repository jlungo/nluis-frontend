    ...
    const data = [
        {
            ...
            title: 'National Land Use M&E',
            description: 'Create, edit, and manage all your National Land Use M&E projects',
        ...
        },
        {
            ...
            title: 'Zonal Land Use M&E',
            description: 'Create, edit, and manage all Zonal Land Use M&E projects',
        ...
        },
        {
            ...
            title: 'Regional Land Use M&E',
            description: 'Create, edit, and manage all your Regional Land Use M&E projects',
        ...
        },
        {
            ...
            title: 'District Land Use M&E',
            description: 'Create, edit, and manage all District Land Use M&E projects',
        ...
        },
        {
            ...
            title: 'Village Land Use M&E',
            description: 'Create, edit, and manage all Village Land Use M&E projects',
    ...
    return (
        <div className="space-y-4">
            <div className="flex justify-between">
                <div>
                    <h1 className="text-xl lg:text-2xl font-semibold">Land Use M&E Management</h1>
                    <p className="text-muted-foreground">Create, edit, and manage all land use M&E projects</p>
                </div>
            </div>
                        ...
                        <Tooltip>
                            <TooltipTrigger asChild>
                                <Card
                                    ...
                                    onClick={() => navigate(`/monitoring-and-evaluation/mne-projects/${item.id}`)}
                                >
