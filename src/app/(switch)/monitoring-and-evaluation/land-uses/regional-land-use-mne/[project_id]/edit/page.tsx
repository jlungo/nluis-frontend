...
export default function Page() {
  ...
  return <CreateOrEditProject projectId={project_id as string} moduleLevel={LOCALITY_LEVELS.REGION} redirectPath="/monitoring-and-evaluation/land-uses/regional-land-use-mne" />
}