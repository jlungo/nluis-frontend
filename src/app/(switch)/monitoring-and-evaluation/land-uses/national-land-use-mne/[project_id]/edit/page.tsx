...
export default function Page() {
  ...
  return <CreateOrEditProject projectId={project_id as string} moduleLevel={LOCALITY_LEVELS.NATIONAL} redirectPath="/monitoring-and-evaluation/land-uses/national-land-use-mne" />
}