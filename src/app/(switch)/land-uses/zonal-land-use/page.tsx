...
// Main Component
export default function ZonalLandUsePage() {
              ...
              <TableBody>
                {enhancedProjects.map((project) => (
                  <TableRow key={project.slug} className="hover:bg-gray-50">
                    ...
                    <TableCell className="text-sm">{project.section_name || 'Zonal Land Use'}</TableCell>
