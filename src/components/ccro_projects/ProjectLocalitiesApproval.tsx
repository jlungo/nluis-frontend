...
import { queryCCROProjectKey as queryProjectKey } from "@/queries/useCCROProjectQuery";
            ...
            <DialogContent className="sm:max-w-3xl max-h-[95vh] overflow-y-auto">
                ...
                {project?.localities && project.localities.length > 0 ? (
                    <div className="space-y-2 max-h-[70vh] overflow-y-auto overflow-x-visible p-2">
                        ...
                        {project.localities
                            .filter((locality: any) => isApproval ? locality.approval_status !== 2 : locality.approval_status === 1)
                            .map((locality: any) => {
