...
import { useCCROFunders as useFunders, useCreateCCROProject as useCreateProject, queryCCROProjectKey as queryProjectKey, useUpdateCCROProject as useUpdateProject, useCCROProjectQuery as useProjectQuery } from '@/queries/useCCROProjectQuery';
...
function Forms({ moduleLevel, redirectPath = '/ccro-management/ccro-projects', localities, funders, project, organizationId }: FormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!project) {
        await mutateAsyncCreate(payload as unknown as any);
      } else {
        await mutateAsyncUpdate({ id: String(project.id), data: payload as unknown as any }).then(() =>
