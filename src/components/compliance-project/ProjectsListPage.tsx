    ...
    <>
      ...
      <div className='flex justify-between items-start'>
        <div className='space-y-1'>
          <h1 className="text-lg lg:text-2xl font-semibold capitalize">{decodeURIComponent(moduleLevel.replace(/-/g, " "))} Compliance Projects</h1>
          <p className="text-muted-foreground text-sm">Manage and track land use planning compliance projects</p>
        </div>
        {canCreate() ? (
