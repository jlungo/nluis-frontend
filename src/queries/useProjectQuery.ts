...
export const useRelatedProjectQuery = (project_id?: string) => {
  return useQuery<RelatedProjectI[]>({
    queryKey: [queryProjectKey, project_id, { related: true }],
    queryFn: () =>
      api
        .get(`/projects/${project_id}/related-projects/list/`)
